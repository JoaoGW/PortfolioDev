...
const menuStyle = tva({
  base: 'rounded-md bg-white border border-gray-200 p-1 shadow-lg z-[9999]',
});

const menuItemStyle = tva({
  base: 'min-w-[200px] p-3 flex-row items-center rounded data-[hover=true]:bg-gray-50 data-[active=true]:bg-gray-100 data-[focus=true]:bg-gray-50 data-[focus=true]:web:outline-none data-[focus=true]:web:outline-0 data-[disabled=true]:opacity-40 data-[disabled=true]:web:cursor-not-allowed data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-primary-700 data-[focus-visible=true]:web:outline data-[focus-visible=true]:web:cursor-pointer data-[disabled=true]:data-[focus=true]:bg-transparent web:cursor-pointer',
});
...
const menuItemLabelStyle = tva({
  base: 'text-gray-900 font-normal font-body',
