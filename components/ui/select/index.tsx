...
const selectTriggerStyle = tva({
  base: 'border border-gray-300 rounded flex-row items-center overflow-hidden data-[hover=true]:border-gray-400 data-[focus=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-gray-300',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
...
const selectInputStyle = tva({
  base: 'px-3 placeholder:text-gray-500 web:w-full h-full text-gray-900 pointer-events-none web:outline-none ios:leading-[0px] py-0',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
  ...
  return (
    <UISelect.Icon
      className={selectIconStyle({
        ...
        parentVariants: {
          size: parentSize as "2xs" | "xs" | "sm" | "md" | "lg" | "xl" | undefined,
        },
      })}
      ref={ref}
      {...props}
