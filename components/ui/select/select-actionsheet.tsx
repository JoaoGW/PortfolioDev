...
const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-gray-50 active:bg-gray-100 data-[focus=true]:bg-gray-100 web:data-[focus-visible=true]:bg-gray-100 data-[checked=true]:bg-gray-100',
});

const actionsheetItemTextStyle = tva({
  base: 'text-gray-700 font-normal font-body tracking-md text-left mx-2',
  variants: {
    isTruncated: {
      true: '',
    },
...
const actionsheetDragIndicatorStyle = tva({
  base: 'w-16 h-1 bg-gray-400 rounded-full',
});
...
const actionsheetSectionHeaderTextStyle = tva({
  base: 'leading-5 font-bold font-heading my-0 text-gray-500 p-3 uppercase',
  variants: {
    isTruncated: {
      true: '',
    },
