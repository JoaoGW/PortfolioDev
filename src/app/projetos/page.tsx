    ...
    <div>
      ...
      <section className='flex flex-col bg-slate-900 p-16'>
        ...
        <div className="flex flex-row justify-center flex-wrap gap-8 w-[70%] mt-8 mx-auto">
          <TechFilterButton techLogo={ ReactLogo } techName="React" filterAction={ () => setActiveFilter("React") } />
          <TechFilterButton techLogo={ ReactNativeLogo } techName="React Native" filterAction={ () => setActiveFilter("React Native") } />
          <TechFilterButton techLogo={ PythonLogo } techName="Python" filterAction={ () => setActiveFilter("Python") } />
          <TechFilterButton techLogo={ TypeScriptLogo } techName="TypeScript" filterAction={ () => setActiveFilter("TypeScript") } />
          <TechFilterButton techLogo={ JavaScriptLogo } techName="JavaScript" filterAction={ () => setActiveFilter("JavaScript") } />
          <TechFilterButton techLogo={ NextJSLogo } techName="Next.js" filterAction={ () => setActiveFilter("Next.js") } />
          <TechFilterButton techLogo={ VueJSLogo } techName="Vue.js" filterAction={ () => setActiveFilter("Vue.js") } />
          <TechFilterButton techLogo={ ExpoLogo } techName="Expo" filterAction={ () => setActiveFilter("Expo") } />
          <TechFilterButton techLogo={ NodeJSLogo } techName="Node.js" filterAction={ () => setActiveFilter("Node.js") } />
          <TechFilterButton techLogo={ GCPLogo } techName="GCP" filterAction={ () => setActiveFilter("GCP") } />
          <TechFilterButton techLogo={ MongoDBLogo } techName="MongoDB" filterAction={ () => setActiveFilter("MongoDB") } />
        </div>
        <div className="mt-12 flex flex-row justify-center gap-8 flex-wrap">
          <ProjectCard 
            ...
            bgImageUrl={ EZTripBG }
            hoverImageurl={ "https://miro.medium.com/1*a-HMmQFQNC76zCZBZfFgJg.gif" }
            imageCredits="Image by Stuart Bailey from Pixabay"
            technologies={["React Native", "TypeScript", "Expo", "OpenAI", "Firebase"]}
          />
          <ProjectCard 
            cardTitlte="Sr. Gee"
            ...
            bgImageUrl={ SrGeeBG }
            hoverImageurl={ "https://miro.medium.com/1*kRpcLblCI85FYhvmTxjt3Q.gif" }
            imageCredits="Image by Stuart Bailey from Pixabay"
